...
BLOCK_HEADER *first_header;  head pointer of heap

// **********************************************
// *****   INITIALIZE MEMORY FOR OUR HEAP   *****
// **********************************************
void *__start_of_heap; // free heap when finished

// this function calls malloc to reserve space for us to manage the memory allocator
